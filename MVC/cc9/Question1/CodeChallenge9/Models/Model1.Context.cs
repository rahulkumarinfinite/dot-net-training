...
namespace CodeChallenge9.Models
{
    ...
    public partial class northwindEntities : DbContext
    {
        ...
        [DbFunction("northwindEntities", "fn_getcust_bycountry")]
        public virtual IQueryable<fn_getcust_bycountry_Result> fn_getcust_bycountry(string countryName)
        {
            var countryNameParameter = countryName != null ?
                new ObjectParameter("countryName", countryName) :
                new ObjectParameter("countryName", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<fn_getcust_bycountry_Result>("[northwindEntities].[fn_getcust_bycountry](@countryName)", countryNameParameter);
        }
