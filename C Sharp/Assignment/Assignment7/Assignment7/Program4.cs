...
using Library4;
// Create a class library with a function CalculateConcession()  that takes age as an input and calculates
...
//Age from the user and call the CalculateConcession() function to test the Classlibrary functionality
    ...
    class Program4
    {
        ...
        static void Main()
        {
           ...
           int age = int.Parse(Console.ReadLine());
            string result = Liberary.CalculateConcession(age, TotalFare);
